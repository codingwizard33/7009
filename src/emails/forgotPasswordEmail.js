...
const forgotPasswordEmail = async (req) => {
                    ...
                    <table width="600" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td style="padding: 20px;">
                                ...
                                <a href="http://7009.local/auth/reset-password/${token}" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none;">Reset password</a>
                        ...
                        <tr>
                            <td style="background-color: #f0f0f0; text-align: center; padding: 20px;">
                                <p>&copy; 2023 7009. All rights reserved.</p>
                            </td>
                        </tr>
                    </table>
                </td>
  ...
  return await emailSendService(data);
};
